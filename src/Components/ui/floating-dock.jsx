  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
            ...
            {items.map((item, idx) => (
              ...
              >
                <a
                  href={item.href}
                  key={item.title}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-surface border border-white/10"
                >
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-bg/90 backdrop-blur-xl border border-white/10"
      >
